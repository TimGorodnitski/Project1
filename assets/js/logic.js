...
function initMap() {
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/San+Diego&s=json",
      method: "get"
    })
      ...
      .then(function() {
        for (i = 0; i < bars.length; i++) {
          ...
          $.ajax({
            url:
              "https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyA_y6oBbAUYyXY4weFYWZ4iY5SzYTv72gw&address=" +
              tempAddress,
            method: "get"
            ...
            var contentString =
              ...
              "<a href=https://" +
              bars[tempI].url +
              " target='_blank'> |WEBSITE| </a><br></p></div>"; //js
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Philadelphia&s=json",
      method: "get"
    })
      .then(function(response1) {
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Denver&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Portland&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Boston&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Seattle&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Kansas+City&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Raleigh&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Milwaukee&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  // New York Map
  var mapCenter10 = new google.maps.LatLng(40.7128, -74.006);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/New+York&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/San+Francisco&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
  ...
  setTimeout(function() {
    $.ajax({
      url:
        "https://beermapping.com/webservice/loccity/a75f6148bb9e67fc48410cb0be9bfe50/Chicago&s=json",
      method: "get"
    })
      .then(function(response1) {
        console.log(response1);
...
$(".thumb").on("click", function() {
  $(this)
    ...
    .appendTo($(".poptrox-popup"));
  $(".poptrox-popup").css("overflow", "hidden");
});


$(document).on("click", ".thumb", function() {
  // $(this).find(".gmnoprint").attr('style', 'margin: "10px; user-select: none; position: absolute; right: 40px; bottom: 350px;"');
  console.log("hello");
