/* jquery.poptrox.js v2.5.2-dev | (c) @ajlkn | github.com/ajlkn/jquery.poptrox | MIT licensed */ ! function (e) {
    e.fn.poptrox_disableSelection = function () {
        ...
        var p, i, s = e.extend({
            ...
            // This makes the whole popup overlay
        ...
        return l.on("resize orientationchange", function () {
            ...
            if ("ignore" != n && i.attr("href")) {
                ...
                "file:" == window.location.protocol && t.src.match(/^\/\//) && (t.src = "http:" + t.src), u.push(t), r.removeAttr("title"), i.removeAttr("href").css("cursor", "pointer").css("outline", 0).on("click", function (e) {
                    e.preventDefault(), x.trigger("poptrox_open", [o])
                })
            }
        }), r.prop("_poptrox", s), r
    }
